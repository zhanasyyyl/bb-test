"""
Django settings for bluebook_project project.
...
if not SECRET_KEY:
    if DEBUG:
        SECRET_KEY = 'django-insecure-)l2n*1ef=5v34*&&(4inn3!1*g@01l+hp638f)_e+pkofox&9^'
    else:
...
MIDDLEWARE = [
    ...
    'bluebook_project.middleware.SecurityHeadersMiddleware',
]

ROOT_URLCONF = 'bluebook_project.urls'
...
WSGI_APPLICATION = 'bluebook_project.wsgi.application'
...
WHITENOISE_MAX_AGE = 31536000  # 1 year — safe because hashed filenames auto-bust cache
...
# Desmos calculator API key (public / domain-restricted)
